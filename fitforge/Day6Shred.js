...
const Day6Shred = ({ navigation }) => {
  const workout = {
    ...
    rest: 'N/A',
    imageUri:
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRDh0coyAUJUnQ0hpEU5A8ApKKuQ1Kc9l8t5A&s',
  };
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate('Day7Shred')}>
